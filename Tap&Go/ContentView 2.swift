...
//                            .frame(width: UIScreen.main.bounds.width * 0.60, height: UIScreen.main.bounds.width * 0.6)
//                            .clipShape(Circle())
...
//                        .zIndex(1)
//
//                        Spacer(minLength: 20) // Adjusting the spacer to reduce bottom gap
//                    }
